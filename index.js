...
function teamColors(team) {
  ...
  } else if (gameObject["away"]["teanName"] == team) {
...
function teamNames() {
  nameArray = [];
  nameArray.push(gameObject["home"]["teamName"]);
  nameArray.push(gameObject["away"]["teamName"]);
  return (nameArray);
}
...
function playerNumbers(team) {
  ...
  if (gameObject["home"]["teamName"] == team) {
    for (player in gameObject["home"]["players"]) {
      numberArray.push(gameObject["home"]["players"][player]["number"])
    }
  } else if (gameObject["away"]["teamName"] == team) {
    for (player in gameObject["away"]["players"]) {
      numberArray.push(gameObject["away"]["players"][player]["number"])
    }
  }
  return numberArray;
}
